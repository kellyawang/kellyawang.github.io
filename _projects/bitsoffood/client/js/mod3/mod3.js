...
// Config svg
const mod3_svgW = 1440;
const mod3_svgH = 712;

// Append svg
const mod3_svg = d3.select('#timeVis')
    .append('svg')
...
class Mod3Main {
    ...
    initVis() {
        ...
        // Config g
        vis.gMargin = {top: 40, right: (mod3_svgW - mod3_svgH) / 2, bottom: 40, left: (mod3_svgW - mod3_svgH) / 2};
        ...
        vis.legendG = vis.mainG.append('g')
            .attr('class', 'legendG')
            .style('transform', `translate(${vis.gW * 0.5}px, ${vis.gW * 0.25}px)`);
        ...
        vis.rotateG.append('text')
            ...
            .style('transform', `translateY(${vis.mainGraphExt * 0.125}px)`)
            .text('rotate');
        ...
        vis.sortButtonG.append('text')
            .attr('class', 'symbolText')
            .style('transform', `translateY(${-vis.mainGraphExt * 0.09}px)`)
            .text('click to sort');
                ...
                enter => enter
                    ...
                    .each(function (d, i) {
                        ...
                        geoG.append('text')
                            ...
                            .text(() => {
                                if (d.geo === 'Country') {
                                    return `Population: ${d3.format(',')(d.countryPop)}`;
